...
This library works in the browser, in Node, and on the commandline (CLI), which we think is great. You can start a local environement to test te UI with `npm start`
